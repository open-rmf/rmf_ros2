...
#ifndef _PYROBOTCOMMANDHANDLE_H
#define _PYROBOTCOMMANDHANDLE_H

#include <pybind11/pybind11.h>
#include <rmf_mock_adapter/adapter.hpp>

// Inheritance Tree: RobotCommandHandle -> SharedRobotCommandHandle
// Trampoline class for RobotCommandHandle to support inheritance downcasting
class _PyRobotCommandHandle : public rmf_mock_adapter::RobotCommandHandle
{
  // Inherit constructor
